...
const AuthorityRegister = () => {
  ...
  return (
    <div className="auth-page">
      <aside className="auth-page__aside auth-page__aside--authority">
        ...
        <div className="auth-page__aside-body">
          ...
          <h1>Coordinate and respond rapidly.</h1>
          <p>
            Create an authority account to monitor incoming SOS alerts on a live map 
            and coordinate emergency responses across your unit.
          </p>
        </div>
      ...
      <div className="auth-page__main">
        <div className="auth-page__form-wrap">
          <div className="auth-page__header">
            ...
            <p>Sign up to access the monitoring dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-page__form">
            ...
            <button type="submit" className="auth-page__submit auth-page__submit--authority" disabled={loading}>
              {loading ? <span className="auth-page__spinner" /> : 'Create account'}
            </button>
          </form>

          <p className="auth-page__register">
            Already have an account? <Link to="/authority/login">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
